...
{
    [Fact]
    public async Task ShouldDeleteCalendarAndEventsWhenUserCanDeleteCalendarForDeleteAsync()
    {
        // Then
        // Given
        ...
        // When
        await calendarProcessingService.DeleteAsync(calendar.Id);
    ...
    public async Task ShouldThrowSecurityExceptionWhenUserLacksDeletePrivilegeForDeleteAsync()
    {
        ...
        // When
        Func<Task> act = async () => await calendarProcessingService.DeleteAsync(calendar.Id);
