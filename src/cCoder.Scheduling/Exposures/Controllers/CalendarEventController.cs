...
namespace cCoder.Scheduling.Exposures.Controllers;
...
public partial class CalendarEventController : ODataController
{
    ...
    public IActionResult GetMetadata()
    {
        ...
        return isExtendedMetaRequest
            ? Ok(
                new cCoder.Scheduling.Api.OData.SchedulingModelBuilder()
                    .Build()
    ...
    public async Task<IActionResult> Post([FromBody] CalendarEvent entity)
    {
        if (!ModelState.IsValid)
            return new cCoder.Scheduling.Api.OData.BadRequestResult(ModelState);
